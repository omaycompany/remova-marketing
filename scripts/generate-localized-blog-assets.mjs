...
function heroSvg(market) {
  ...
  <title id="title">${escapeXml(market.label)} AI governance article visual</title>
  <desc id="desc">AI-assisted editorial visual for ${escapeXml(market.industry)} governance controls.</desc>
  <defs>
