...
export default function GuestProductDemo() {
    ...
    return (
        <>
            <div className="mx-auto w-full max-w-7xl rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-white/10 dark:bg-[#131314]">
                ...
                <div className="relative flex min-h-[680px] overflow-hidden rounded-b-3xl">
                    {menuOpen && (
...
export function DemoEntryCard() {
    return (
        <div className="rounded-3xl border border-slate-200 bg-white p-6 dark:border-white/10 dark:bg-[#171718]">
            <div className="flex items-start gap-3">
                <div className="rounded-full bg-slate-100 p-2 text-slate-700 dark:bg-white/10 dark:text-slate-100">
                    <MessageSquare className="h-4 w-4" />
                </div>
                <div>
                    <p className="text-sm font-semibold uppercase tracking-[0.12em] text-emerald-600 dark:text-emerald-400">Product-Led Onboarding</p>
                    <h2 className="mt-1 text-2xl font-black text-slate-900 dark:text-white">Explore the real interface in demo mode</h2>
                    <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
                        Browse chat and dashboard with synthetic data. Write actions stay locked until signup.
                    </p>
                </div>
            </div>
        </div>
