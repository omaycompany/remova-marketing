...
export default function GuestProductDemo() {
    ...
    return (
        <>
            <div className="w-full min-h-[calc(100dvh-6rem)] border-y border-slate-200 bg-white dark:border-white/10 dark:bg-[#131314]">
                ...
                <div className="relative flex min-h-[calc(100dvh-9rem)] overflow-hidden">
                    {menuOpen && (
