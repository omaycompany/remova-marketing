...
import { localizedAiGovernanceBlogPosts } from "./localized-ai-governance-blog-posts";
...
If a team believes Claude Fable 5 is necessary for a specific non-sensitive workload, treat that as an exception request, not a default rollout. The request should name the workflow, allowed data classes, retention acceptance, reviewers, logging requirements, and expiration date. Until those details are approved, Remova's position is simple: we do not include Claude Fable 5 because we do not accept the required data retention and review policy for ordinary customer workflows.`
    ...
    },
    {
        ...
        metaDescription: "Retrieval-Augmented Generation (RAG) can reduce unsupported answers, but it creates data access, source quality, and audit risks. Learn how to fix them.",
        category: "Compliance",
        date: "2026-06-15",
...
A practical rollout can start in thirty days. Week one: identify the top AI workflows and data classes. Week two: map owners, model routes, policy rules, and evidence sources. Week three: route those workflows through controls for access, data protection, and logging. Week four: review usage, exceptions, spend, and policy events with the owners. The first cycle will not be perfect, but it will expose the real operating gaps faster than another framework workshop.`
    ...
    },
    {
        ...
        faqs: [
            ...
            {
                question: "Did the California AI Transparency Act become operative on January 1, 2026?",
                answer: "That was the original SB 942 timing. AB 853, approved and filed on October 13, 2025, delayed operation of the chapter to August 2, 2026 and added later phased obligations for large online platforms, GenAI hosting platforms, and capture-device manufacturers."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        title: "EU AI Act Readiness: Updated Timeline and 2026 Prep Work",
        metaDescription: "Updated EU AI Act readiness guide for enterprise teams, including the revised high-risk timeline, 2026 obligations, inventory, documentation, oversight, and evidence work.",
        category: "Compliance",
        date: "2026-04-23",
        lastModified: "2026-05-21",
        articleType: "NewsArticle",
        readTime: "9 min",
        excerpt: "This older EU AI Act guide has been updated to reflect the newer high-risk timeline and to point readers to Remova's newer EU AI Act timeline article.",
        sections: [
            { heading: "Update: Read This With the Newer Timeline", content: "Update, May 21, 2026: this older page has been revised so readers do not treat August 2, 2026 as the only date for high-risk AI requirements. Remova's newer <a href='/blog/eu-ai-act-timeline-companies-2026-delay'>EU AI Act timeline article</a> should be used for current planning. The <a href='https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai' target='_blank' rel='noopener noreferrer'>European Commission's AI Act overview</a> now describes a revised implementation timeline after the political agreement on the AI omnibus: rules for certain stand-alone high-risk areas, including biometrics, critical infrastructure, education, employment, migration, asylum, and border control, are described as applying from December 2, 2027, while rules for high-risk systems integrated into regulated products are described as applying from August 2, 2028. The AI Act still has important 2026 work, including transparency obligations and broader enforcement readiness. Enterprise teams should confirm exact legal applicability with counsel, but operational work should continue: inventory, role classification, documentation, human oversight, monitoring, and evidence trails take months to build." },
        ...
        faqs: [
            { question: "Does the EU AI Act apply to US companies?", answer: "Yes, depending on the role, system, market placement, and whether outputs are used in the EU. US enterprises with EU customers, employees, or operations should map provider, deployer, GPAI, transparency, and high-risk obligations with legal counsel instead of relying on one date." },
            ...
            { question: "What should enterprise teams do first to prepare?", answer: "The most important first step is completing an accurate AI inventory across all departments, including tools procured outside central IT. Without knowing what systems are in use, role classification, risk classification, documentation, and monitoring requirements cannot be scoped." },
        ],
    },
    {
    ...
    },
    {
        ...
        title: "AI Cost Overruns: Hidden Expenses Enterprise Teams Miss",
        metaDescription: "Most enterprise AI cost overruns come from hidden operational expenses, model routing drift, tool sprawl, and unowned usage. Here is how to regain control.",
        category: "FinOps",
        date: "2026-04-29",
        articleType: "NewsArticle",
        readTime: "10 min",
        ...
        faqs: [
            ...
            { question: "How should teams reduce AI cost without hurting quality?", answer: "Start by routing routine tasks to appropriate model tiers, removing duplicate tools, setting department budgets, reviewing high-cost workflows, and measuring output quality before and after changes. Cost cuts should be tied to workflow evidence, not guesswork." },
        ],
    },
    {
    ...
    },
    {
        ...
        faqs: [
            ...
            { question: "Why is governing multi-agent systems difficult?", answer: "Multi-agent systems can create many model calls, tool calls, intermediate summaries, and transient agent identities from one user request. Without identity management and logging, organizations lose traceability and cannot determine which agent took an action, why it did so, or which human initiated the workflow." },
    ...
    },
    {
        ...
        articleType: "BlogPosting",
        readTime: "12 min",
        excerpt: "Connecting an LLM to internal knowledge can reduce unsupported answers, but RAG still needs access controls, source quality rules, citations, and groundedness evaluation.",
        sections: [
            { heading: "The Governance Trade-off of RAG", content: "<a href='/glossary/rag'>Retrieval-Augmented Generation</a> (<a href='/glossary/rag'>RAG</a>) — or knowledge grounding — is a standard enterprise pattern for making AI outputs more accurate and context-aware. By retrieving relevant internal documents and feeding them to the model alongside the user's prompt, <a href='/glossary/rag'>RAG</a> can reduce unsupported answers and anchor responses in organizational material. It does not eliminate hallucinations. A grounded system can still produce wrong answers when source material is stale, conflicting, over-broad, inaccessible to the user, or cited in a misleading way. The practical claim should be: RAG reduces one class of unsupported answer, then creates new control requirements around access, retrieval quality, source freshness, citation confidence, and evaluation." },
    ...
    },
    {
        ...
        faqs: [
            ...
            { question: "How do preset workflows improve AI controls?", answer: "They embed controls directly into the task. Preset workflows can define allowed data classes, blocked inputs, approved model routes, field-level redaction, review steps, escalation paths, and audit evidence before employees run the workflow." },
...
const combinedBlogPosts = [...rawBlogPosts, ...euAiActTimelineBlogPosts, ...aiToolsBlogPosts, ...aiCodeGeneratorBlogPosts, ...aiSecurityRisksBlogPosts, ...aiChatbotArchiveBlogPosts, ...aiChatbotBuilderBlogPosts, ...aiWritingAssistantBlogPosts, ...agenticWorkflowsBlogPosts, ...chatgptAlternativesBlogPosts, ...companyAiBlogPosts, ...codingAiBlogPosts, ...customerServiceAiBlogPosts, ...salesEmailBlogPosts, ...localizedAiGovernanceBlogPosts, ...keywordBlogPosts];
