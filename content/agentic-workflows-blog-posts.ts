...
Use established risk references for orientation, including the <a href="https://www.nist.gov/itl/ai-risk-management-framework" target="_blank" rel="noopener noreferrer">NIST AI Risk Management Framework</a>, the <a href="https://owasp.org/www-project-top-10-for-large-language-model-applications/" target="_blank" rel="noopener noreferrer">OWASP Top 10 for Large Language Model Applications</a>, and <a href="https://www.iso.org/standard/42001" target="_blank" rel="noopener noreferrer">ISO/IEC 42001</a>. Then translate those references into operating decisions. Who owns the workflow? Which data classes may the agent see? Which systems can it update? Which actions require human approval? What evidence proves the workflow stayed inside its boundary?
