...
export const useCases: UseCase[] = [
    ...
    },
    {
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: "By utilizing Remova's Knowledge Grounding (<a href='/glossary/rag'><a href='/glossary/rag'>RAG</a></a>), you can restrict legal drafting and research workflows to verified firm repositories and require citations, reducing the risk of unsupported case-law claims."
            },
            {
                question: "Can we maintain ethical walls between practice groups?",
                answer: "Yes. <a href='/features/role-access-control'><a href='/features/role-access-control'>Role-Based Access Control</a></a> and isolated Team Workspaces can segregate data, prompts, and uploaded knowledge bases between different legal departments."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        description: "The insurance industry sits on large volumes of unstructured data: claim reports, medical records, property photos, and complex policy documents. Generative AI can help summarize claims histories, identify review patterns, and draft policy updates. However, for a Chief Risk Officer (CRO) or CTO, adopting AI presents a critical challenge: protecting sensitive claimant data and ensuring that AI-assisted underwriting or claims workflows comply with applicable privacy, unfair-discrimination, and insurance oversight rules.\n\nWithout governance, an actuary using an unsanctioned public AI model to analyze a complex commercial claim risks exposing proprietary risk models and client PII to third-party vendors. If AI is used to draft a denial of coverage without proper human oversight and auditability, the insurer also faces legal and customer-impact risk. Remova provides a governance layer for AI across the insurance value chain. By intercepting prompts before approved model requests are sent, Remova can redact PII and sensitive claim details, reducing privacy exposure while allowing adjusters to use LLMs for drafting and analysis.\n\nCrucially, Remova enables workflow controls and Knowledge Grounding. Instead of letting an AI guess the details of a specific policy, Remova can connect the AI to a verified internal policy repository using <a href='/glossary/rag'>Retrieval-Augmented Generation</a> (<a href='/glossary/rag'><a href='/glossary/rag'>RAG</a></a>), so answers for agents or underwriters are grounded in approved corporate guidelines and citations where configured.",
        challenges: [
    ...
    },
    {
        ...
        faqs: [
            ...
            { question: "How do we handle different data laws across our global plants?", answer: "By using <a href='/features/role-access-control'><a href='/features/role-access-control'>Role-Based Access Control</a></a> and Team Workspaces, you can apply retention and access policies aligned with GDPR requirements for European factories while maintaining different settings for US operations." }
        ],
        lastModified: "2026-04-26"
    },
    {
