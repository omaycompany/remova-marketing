...
export const alternatives: Alternative[] = [
    {
        ...
        removaAdvantages: [
            ...
            { title: "Governance-First Architecture", description: "Apply global and department-specific policies, such as automatic PII redaction and <a href='/glossary/prompt-injection'>prompt injection</a> blocking, across all AI usage instantly." },
    ...
    },
    {
        ...
        removaAdvantages: [
            { title: "Universal Governance Layer", description: "Remova sits above any single ecosystem, applying consistent <a href='/features/sensitive-data-protection'>DLP</a>, logging, and access policies whether the user is in a chat interface or an internal developer tool." },
    ...
    },
    {
        ...
        removaAdvantages: [
            { title: "Unified Operating System", description: "Consolidate <a href='/features/sensitive-data-protection'>DLP</a>, <a href='/glossary/prompt-injection'>prompt injection</a> protection, cost governance, and a consumer-grade chat interface into a single, cohesive platform." },
        ...
        faqs: [
            ...
            { question: "Can Remova replace our existing DLP solution?", answer: "Remova is specifically designed for the unique challenges of generative AI (contextual language, unstructured data). It works alongside your traditional network <a href='/features/sensitive-data-protection'>DLP</a> by securing the specific pathway between your employees and LLM APIs." },
    ...
    },
    {
        ...
        faqs: [
            { question: "Can Remova connect to our internal documents like a search assistant does?", answer: "Yes. Remova's Team Workspaces allow you to upload or connect specific datasets (via <a href='/glossary/rag'>RAG</a>) to create highly accurate, grounded AI assistants tailored to specific departmental needs." },
    ...
    },
    {
        ...
        faqs: [
            ...
            { question: "Can Remova read our SharePoint data?", answer: "Yes, Remova can securely connect to SharePoint as a <a href='/glossary/rag'>RAG</a> knowledge base, but it enforces strict identity propagation, ensuring the AI only retrieves documents the specific user is authorized to see." }
        ]
    },
    {
    ...
    },
    {
        ...
        removaAdvantages: [
            { title: "Cross-Platform Governance", description: "Apply a single, unified set of security policies and <a href='/features/sensitive-data-protection'>DLP</a> rules across all AI traffic, whether it originates from a Google Doc, a custom app, or a Slack integration." },
            ...
            { title: "Cost Optimization", description: "Utilize Remova's <a href='/features/department-budgets'>FinOps</a> dashboard to monitor API consumption across all vendors, set department budgets, and eliminate unnecessary seat licenses." }
        ],
        faqs: [
            ...
            { question: "Why not just use Google's built-in DLP?", answer: "Google's <a href='/features/sensitive-data-protection'>DLP</a> is excellent for Google Drive, but Remova provides specialized *AI-centric* <a href='/features/sensitive-data-protection'>DLP</a>. It understands the semantic context of a prompt and can actively redact data before it hits an external API, protecting data that doesn't live in Drive." },
    ...
    },
    {
        ...
        removaAdvantages: [
            ...
            { title: "No-Code Governance", description: "Empower your Security and Compliance teams to define <a href='/features/sensitive-data-protection'>DLP</a> rules, toxicity filters, and access controls through an intuitive dashboard, without requiring developer intervention." },
        ...
        faqs: [
            ...
            { question: "Can we use Bedrock models through Remova?", answer: "Yes. You can easily configure Remova to route prompts to any of the <a href='/glossary/foundation-model'>foundation models</a> hosted in your Amazon Bedrock environment." },
            { question: "Why shouldn't we just build our own chat UI on Bedrock?", answer: "Building a chat UI is easy; building enterprise-grade governance is incredibly hard. Remova saves you the hundreds of engineering hours required to build <a href='/features/role-access-control'>RBAC</a>, <a href='/features/department-budgets'>FinOps</a> tracking, audit logging, and inline semantic <a href='/features/sensitive-data-protection'>DLP</a>." },
