...
export const features: Feature[] = [
    ...
    },
    {
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: "No. The documents are used purely for retrieval-augmented generation (<a href='/glossary/rag'>RAG</a>) at inference time. Your data is never used to train the base <a href='/glossary/foundation-model'>foundation models</a>."
            },
            {
    ...
    },
    {
        ...
        faqs: [
            ...
            },
            {
                ...
                answer: "Access is strictly controlled by <a href='/features/role-access-control'>Role-Based Access Control</a> (<a href='/features/role-access-control'>RBAC</a>). Typically, only designated compliance officers, legal counsel, and top-tier IT admins have permission to view global unredacted logs."
            },
            {
    ...
    },
    {
        ...
        metaDescription: "Add AI to your internal tools through Remova's API. Same rules, same audit trail, same cost controls as everything else.",
        headline: "API Access",
